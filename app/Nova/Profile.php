    ...
    */
    ...
    public function fields(Request $request)
    {
        return [
            ...
            ->sortable(),
            Text::make( __('Paypal'),  'paypal')->hideFromIndex(),
            Text::make( __('Skrill'),  'skrill')->hideFromIndex(),
            Text::make( __('Mobile Money no'),  'momo')->hideFromIndex(),
            Text::make( __('Mobile Money Network'),  'momo_network')->hideFromIndex(),
            Select::make( __('Mobile Money Country'),  'momo_country')->options([
                'AF' => 'Afghanistan',
                'AX' => 'Aland Islands',
                'AL' => 'Albania',
                'DZ' => 'Algeria',
